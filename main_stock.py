...
from strategy_Shuhan import generate_orders_from_deals
from backtester_stock import backtest
...
def main():
    ...
    price_df = pd.read_csv("price_stock_deals.csv", parse_dates=["date"])
    ...
    print(f"DEBUG: orders_df is {orders_df}")
